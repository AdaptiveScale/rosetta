...
public class SQLServerDDLTest {
    ...
    public void createDB() throws IOException {
        ...
        Assertions.assertEquals(("IF NOT EXISTS (" +
                ...
                "IF NOT EXISTS (SELECT  *    FROM sys.schemas    WHERE name = N'test')EXEC('CREATE SCHEMA test');\n" +
                ...
                "IF NOT EXISTS (SELECT  *    FROM sys.schemas    WHERE name = N'test')EXEC('CREATE SCHEMA test');\n" +
                "CREATE TABLE \"test\".\"EmployeeTerritories\"(\"EmployeeID\" int NOT NULL , \"TerritoryID\" nvarchar NOT NULL , PRIMARY KEY (\"EmployeeID\", \"TerritoryID\"));ALTER TABLE \"test\".\"EmployeeTerritories\" ADD CONSTRAINT \"FK_EmployeeTerritories_Employees\" FOREIGN KEY (\"EmployeeID\") REFERENCES \"test\".\"Employees\"(\"EmployeeID\") ;" +
                ...
                "IF NOT EXISTS (SELECT  *    FROM sys.schemas    WHERE name = N'test')EXEC('CREATE SCHEMA test');\n" +
                "CREATE TABLE \"test\".\"OrderDetails\"(\"OrderDetailsID\" int identity NOT NULL , \"OrderID\" int NOT NULL , \"ProductID\" int NOT NULL , \"UnitPrice\" money NOT NULL , \"Quantity\" smallint NOT NULL , \"Discount\" real NOT NULL , PRIMARY KEY (\"OrderDetailsID\"));ALTER TABLE \"test\".\"OrderDetails\" ADD CONSTRAINT \"FK_Order_Details_Orders\" FOREIGN KEY (\"OrderID\") REFERENCES \"test\".\"Orders\"(\"OrderID\") ;" +
                ...
                "ALTER TABLE \"test\".\"Products\" ADD CONSTRAINT \"FK_Products_Suppliers\" FOREIGN KEY (\"SupplierID\") REFERENCES \"test\".\"Suppliers\"(\"SupplierID\") ;ALTER TABLE \"test\".\"Products\" ADD CONSTRAINT \"FK_Products_Categories\" FOREIGN KEY (\"CategoryID\") REFERENCES \"test\".\"Categories\"(\"CategoryID\") ;" +
                "IF NOT EXISTS (SELECT  *    FROM sys.schemas    WHERE name = N'test')EXEC('CREATE SCHEMA test');\n" +
