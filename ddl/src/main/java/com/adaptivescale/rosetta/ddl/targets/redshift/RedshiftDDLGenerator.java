...
public class RedshiftDDLGenerator implements DDL {

    private final static String TABLE_CREATE_TEMPLATE = "redshift/table/create";

    private final static String TABLE_ALTER_TEMPLATE = "redshift/table/alter";

    private final static String TABLE_ALTER_DROP_PRIMARY_KEY_TEMPLATE = "redshift/table/alter_drop_primary_key";

    private final static String TABLE_ALTER_ADD_PRIMARY_KEY_TEMPLATE = "redshift/table/alter_add_primary_key";

    private final static String TABLE_DROP_TEMPLATE = "redshift/table/drop";

    private final static String SCHEMA_CREATE_TEMPLATE = "redshift/schema/create";

    private final static String FOREIGN_KEY_CREATE_TEMPLATE = "redshift/foreignkey/create";

    private final static String FOREIGN_KEY_DROP_TEMPLATE = "redshift/foreignkey/drop";

    private final static String COLUMN_ADD_TEMPLATE = "redshift/column/add";

    private final static String COLUMN_ALTER_TYPE_TEMPLATE = "redshift/column/alter_column_type";

    private final static String COLUMN_ALTER_NULL_TEMPLATE = "redshift/column/alter_column_null";

    private final static String COLUMN_DROP_TEMPLATE = "redshift/column/drop";

    private final ColumnSQLDecoratorFactory columnSQLDecoratorFactory = new RedshiftColumnDecoratorFactory();
