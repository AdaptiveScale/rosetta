...
public class DefaultSpannerColumnDecorator implements ColumnSQLDecorator {
    private final Column column;
    private final ColumnDataTypeName columnDataTypeName;

    public DefaultSpannerColumnDecorator(Column column, ColumnDataTypeName columnDataTypeName) {
        this.column = column;
