...
import static com.adaptivescale.rosetta.ddl.targets.oracle.Constants.DEFAULT_WRAPPER;

public class DefaultOracleColumnSQLDecorator implements ColumnSQLDecorator {

    private final Column column;
    private final ColumnDataTypeName columnDataTypeName;

    public DefaultOracleColumnSQLDecorator(Column column, ColumnDataTypeName columnDataTypeName) {
        this.column = column;
