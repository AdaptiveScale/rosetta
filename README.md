...
```
curl -L "https://github.com/AdaptiveScale/rosetta/releases/download/v2.8.3/rosetta_setup.sh" -o rosetta_setup && chmod u+x rosetta_setup && ./rosetta_setup
```
...
```
curl -L "https://github.com/AdaptiveScale/rosetta/releases/download/v2.8.3/rosetta_setup.bat" -o rosetta_setup.bat && .\rosetta_setup.bat
```
