...
#### test 
Show differences between model with current state of database. Check if any table is removed, added or any columns has changed.

`usage: rosetta [-c, --config CONFIG_FILE] init [-h, --help] [-s, --source CONNECTION_NAME]`
