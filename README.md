...
`usage: rosetta [-c, --config CONFIG_FILE] extract [-h, --help] [-s, --source CONNECTION_NAME] [-t, --convert-to CONNECTION_NAME] [-o, --output-dir OUTPUT_DIRECTORY]`
...
-o, --output-dir OUTPUT_DIRECTORY | The directory where the source DBML and target DBML are saved in, by default they are saved in the current directory.
...
`usage: rosetta [-c, --config CONFIG_FILE] compile [-h, --help] [-t, --target CONNECTION_NAME] [-i, --input-dir INPUT_DIRECTORY] [-ddl, --ddl-only]`
...
-i, --input-dir INPUT_DIRECTORY | The directory where the source DBML is located, by default they are saved in the current directory.
-ddl, --ddl-only | If this option is specified the DDL will be generated based on the output.
